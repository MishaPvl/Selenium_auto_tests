...
class ProductPage(BasePage):
    ...
    def name_of_the_book_in_basket_and_main_page_should_be_same(self):
        name_on_main_page = self.browser.find_element(*ProductPageLocators.BOOK_NAME_ON_PAGE).text
        name_on_basket = self.browser.find_element(*ProductPageLocators.BOOK_NAME_ON_BASKET).text
        assert name_on_main_page in name_on_basket, 'name of the book in the basket and on the page are different'
    
    def price_of_the_book_in_basket_and_main_page_should_be_same(self):
        price_on_main_page = self.browser.find_element(*ProductPageLocators.BOOK_PRICE_ON_PAGE).text
        price_on_basket = self.browser.find_element(*ProductPageLocators.PRICE_ON_BASKET).text
        assert price_on_basket == price_on_main_page, 'price of the book in the basket and on the page are different'
